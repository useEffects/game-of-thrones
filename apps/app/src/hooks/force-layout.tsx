...
const elementCountSelector = (state: ReactFlowState) => state.nodeLookup.size + state.edges.length;
const nodesInitializedSelector = (state: ReactFlowState) => Array.from(state.nodeLookup.values()).every((node) => node.width && node.height) && state.nodeLookup.size;
